...
# from torchvision.models.video.resnet.utils import _log_api_usage_once
...
class SuperviseL2(nn.Sequential):
    def __init__(self):
        super().__init__(
            nn.Conv3d(128, 64, kernel_size=(1, 7, 7), stride=(1, 2, 2), padding=(0, 3, 3), bias=False),
            nn.ReLU(inplace=True),
...
class VideoResNet(nn.Module):
    def __init__(
        ...
        self.supervisel2 = SuperviseL2()
        self.flat = nn.Flatten(0,1)
        self.f = nn.Linear(in_features=64, out_features=1)
